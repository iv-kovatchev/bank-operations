    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditServices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CorporateClients_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreditServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Credits_CreditServices_CreditServiceId",
                        column: x => x.CreditServiceId,
                        principalTable: "CreditServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsumerCredits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsumerCredits_Credits_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageCredits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MortgageCredits_Credits_Id",
                        column: x => x.Id,
                        principalTable: "Credits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepaymentPlans_Credits_CreditId",
                        column: x => x.CreditId,
                        principalTable: "Credits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RepaymentPlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepaymentInstallments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepaymentInstallments_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepaymentInstallments_RepaymentPlans_RepaymentPlanId",
                        column: x => x.RepaymentPlanId,
                        principalTable: "RepaymentPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Credits_CreditServiceId",
                table: "Credits",
                column: "CreditServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_RepaymentInstallments_CreatedByUserId",
                table: "RepaymentInstallments",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RepaymentInstallments_RepaymentPlanId",
                table: "RepaymentInstallments",
                column: "RepaymentPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_RepaymentPlans_CreditId",
