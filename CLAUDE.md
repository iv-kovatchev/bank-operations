...
- @.claude/knowledge/installments.md — Pay/Unpay installment, bank account withdrawal, automatic Credit.Status PaidOff/Active, IBankAccountRepository injected in CreditService
